...
def init():
    ...
    global game_disp, game_disp2, clock, gamemode, window, window_scaled, scanlines
    ...
    window_scaled = pygame.surface.Surface(window.get_size())
...
def loop():
    ...
    while not stop:     
        ...
        pygame.transform.scale(game_disp.surface, window_scaled.get_size(), window_scaled)

        scanlines.apply(window_scaled)
        
        window.blit(window_scaled, (0, 0))
